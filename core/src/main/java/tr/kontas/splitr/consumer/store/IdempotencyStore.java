...
public interface IdempotencyStore {
     ...
     * @return The {@link BaseResponse} associated with the ID, or {@code null} if not found.
     */
     ...
     *
     * @param id The unique correlation ID.
     * @param r  The response generated by a {@link BaseResponse}.
     */
    void put(String id, BaseResponse r);
}