...
@Slf4j
@Component
public class OrderDomainEventHandler extends BaseDomainEventHandler<OrderDomainEvent> {
    @Override
    public void onEvent(OrderDomainEvent payload) {
        log.atInfo().log("OrderDomainEventHandler triggered with id: " + payload.getId());
    }
}
